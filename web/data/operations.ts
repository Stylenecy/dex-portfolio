...
export const operationLogs: OperationEntry[] = [
  ...
  { id: 'dli-2024',       name: 'DLI 2024',                org: 'Data Lab Indonesia',      role: 'PARTICIPANT', year: '2024', certPdf: '/certificates/Dex Bennett (DLI_24).pdf' },
  ...
  { id: 'pbty',           name: 'PBTY Program',            org: 'Professional Training',   role: 'PARTICIPANT', certPdf: '/certificates/Dex Bennett (PBTY).pdf' },
  ...
  { id: 'dli',            name: 'DLI Program',             org: 'Data Lab Indonesia',      role: 'PARTICIPANT', certPdf: '/certificates/Dex Bennett (DLI).pdf' },
