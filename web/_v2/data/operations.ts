...
export const operationLogs: OperationEntry[] = [
  ...
  { id: 'fti-typing',     name: 'FTI FEST Typing Contest', org: 'FTI Festival',            role: 'COMPETITOR',  certImage: '/images/certificates/Dex Bennett (FTI FEST Typing Contest).webp', certPdf: '/certificates/Dex Bennett (FTI FEST Typing Contest).pdf' },
  { id: 'smartpath',      name: 'SmartPath Program',       org: 'Career Development',      role: 'PARTICIPANT', certImage: '/images/certificates/Dex Bennett (SmartPath).webp', certPdf: '/certificates/Dex Bennett (SmartPath).pdf' },
  { id: 'dilusi',         name: 'DILUSI Program',          org: 'Professional Development', role: 'PARTICIPANT', certPdf: '/certificates/Dex Bennett (DILUSI).pdf' },
  { id: 'berbagi-kasih',  name: 'Berbagi Kasih',           org: 'Community Service',       role: 'VOLUNTEER',   certImage: '/images/certificates/Dex Bennett (Berbagi Kasih).webp', certPdf: '/certificates/Dex Bennett (Berbagi Kasih).pdf' },
  { id: 'dli-2024',       name: 'DLI 2024',                org: 'Dialog Lintas Iman',      role: 'PARTICIPANT', year: '2024', certPdf: '/certificates/Dex Bennett (DLI_24).pdf' },
  { id: 'imlek-imt',      name: 'Imlek IMT × BOSA',        org: 'Lunar New Year Event',    role: 'STAFF',       certImage: '/images/certificates/Dex Bennett (Imlek IMT x BOSA).webp', certPdf: '/certificates/Dex Bennett (Imlek IMT x BOSA).pdf' },
  ...
  { id: 'fti-cocacola',   name: 'FTI × Coca Cola',         org: 'Corporate Partnership',   role: 'PARTICIPANT', certImage: '/images/certificates/Dex Bennett (FTI+ Coca Cola).webp' },
  { id: 'fti-dana',       name: 'FTI × DANA',              org: 'Corporate Partnership',   role: 'PARTICIPANT', certImage: '/images/certificates/Dex Bennett (FTI+ DANA).webp' },
  { id: 'imlek-imt-2',    name: 'Imlek IMT × BOSA 2.0',    org: 'Lunar New Year Event v2', role: 'STAFF',       certImage: '/images/certificates/Dex Bennett (Imlek IMT x BOSA) 2.0.webp', certPdf: '/certificates/Dex Bennett (Imlek IMT x BOSA) 2.0.pdf' },
